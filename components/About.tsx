      ...
      <div className="container grid__section grid-cols-[repeat(2,1fr)] items-center gap-x-16">
        ...
        <div className="about__data">
          ...
          <p className="mb-6 pr-16">
            ...
            combined with my proficiency in a wide range of technologies, allows
            me to build robust, scalable, and visually appealing web
